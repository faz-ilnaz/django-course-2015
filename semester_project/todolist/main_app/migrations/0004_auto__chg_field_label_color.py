...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Label.color'
        db.alter_column(u'main_app_label', 'color_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main_app.Dictionary'], null=True))

    def backwards(self, orm):

        # Changing field 'Label.color'
        db.alter_column(u'main_app_label', 'color_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main_app.Dictionary']))
    ...
    models = {
        ...
        u'main_app.task': {
            ...
            't_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
